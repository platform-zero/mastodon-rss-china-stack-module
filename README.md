# Mastodon RSS China stack module

Content-only Platform Zero module providing curated independent China coverage and Mastodon bootstrap follows to `mastodon-rss-publisher`.
